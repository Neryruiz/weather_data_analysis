...
CREATE TABLE stormevent_details_costperyear as SELECT STATE, YEAR, SUM(DAMAGES), SUM(DEATHS), SUM(INJURIES) FROM stormevent_details_typecostperstate GROUP BY STATE, YEAR;
